...
export default class Ex_Shoe extends Component {
  ...
  handleAddToCart = (shoe) => {
    // 2 trường hợp: sp đã có trong giỏ hàng, sp chưa có trong giỏ hàng
    // kiểm tra sp đã có trong giỏ hàng hay chưa => findIndex: trả về vị trí nếu tìm thấy, nếu không tìm thấy thì trả về -1
